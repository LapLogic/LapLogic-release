...
![Vehicle profile selection](images/v0.1.55/vehicle-profiles.png)

### AI Insights Page

A new page that lists all your AI Setup and Coaching recommendations in one place. 

![Vehicle profile selection](images/v0.1.55/ai-insights.png)
...
![Vehicle profile selection](images/v0.1.55/map-corners.png)
...
![Vehicle profile selection](images/v0.1.55/session-import.png)
