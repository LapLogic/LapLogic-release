...
![Vehicle profile selection](images/v0.1.53/vehicle-profiles.png)

### AI Insights Page

A new page that lists all your AI Setup and Coaching recommendations in one place. 

![Vehicle profile selection](images/v0.1.53/ai-insights.png)

### Track Map Corner Detection

Corners are now automatically detected and displayed on the track map (chekbox in map popout window), giving you visual reference points for your racing line analysis.
...
![Vehicle profile selection](images/v0.1.53/map-corners.png)
...
![Vehicle profile selection](images/v0.1.53/session-import.png)
