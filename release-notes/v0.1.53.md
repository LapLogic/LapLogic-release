...
![Vehicle profile selection](images/v0.1.52/vehicle-profiles.png)

### AI Insights Page

A new page that lists all your AI Setup and Coaching recommendations in one place. 

![Vehicle profile selection](images/v0.1.52/ai-insights.png)
...
![Vehicle profile selection](images/v0.1.52/map-corners.png)
...
![Vehicle profile selection](images/v0.1.52/session-import.png)
